...
public class AccountController : ControllerBase
{
    ...
    public async Task<ActionResult<UserOutputDto>> Register([FromBody] RegisterDto registerDto)
    {
        ...
        user.PasswordSeed = hashedPasswordAndKey.Item2;
    ...
    public async Task<ActionResult<UserOutputDto>> Login([FromBody] LoginDto loginDto)
    {
        // Get the user
